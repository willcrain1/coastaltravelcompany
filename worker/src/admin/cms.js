...
const PAGES = {
  ...
  'about.html': {
    ...
    zones: [
      ...
      { id: 'about-body-p1',      label: 'About body paragraph 1',       type: 'multiline' },
      { id: 'about-body-p2',      label: 'About body paragraph 2',       type: 'multiline' },
      { id: 'about-body-p3',      label: 'About body paragraph 3',       type: 'multiline' },
      ...
      { id: 'bg-bio-1',           label: 'Background paragraph 1',       type: 'multiline' },
      { id: 'bg-bio-2',           label: 'Background paragraph 2',       type: 'multiline' },
      { id: 'bg-bio-3',           label: 'Background paragraph 3',       type: 'multiline' },
      { id: 'pullquote',          label: 'Pull quote',                   type: 'multiline' },
      { id: 'pullquote-cite',     label: 'Pull quote attribution',       type: 'text' },
    ],
  },
